...
function HomePage() {
  ...
  const getSessionId = async () => {
    ...
    try {
      ...
      // Add webhook forwarding URL from config
      const savedApiConfig = JSON.parse(localStorage.getItem('apiConfiguration') || '{}');
      if (savedApiConfig.webhookForwardUrl) {
        requestBody.webhookForwardUrl = savedApiConfig.webhookForwardUrl;
      }
